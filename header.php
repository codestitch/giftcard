...
<?php
	} else if ($basename == 'cards') {
?>   
	<script src="assets/js/angular.min.js"></script>  

<?php
	} else if ($basename == 'card-detail') {
?>   
    <!-- Owl Carousel Assets --> 
	<script src="assets/js/angular.min.js"></script>  
...
<?php
	} else if ($basename == 'checkout') {
?>    
	<script src="assets/js/angular.min.js"></script> 
	<link href="assets/css/style.shop.css" rel="stylesheet" type="text/css"/>   

<?php
	} else if ($basename == 'thankyou') {
?>    
	<script src="assets/js/angular.min.js"></script> 
	<link href="assets/css/style.shop.css" rel="stylesheet" type="text/css"/>   
...
<div class="page-header">
	...
	<div class="page-header-top">
		<div class="container">
			<!-- BEGIN LOGO -->
			<a href="cards.php" class="page-logo"> 
				<img src="assets/img/logo.png" alt="logo" class="logo-default"/>
			</a>
			<!-- <div class="companyname">Lorem Ipsum Ltd.</div> -->
			<!-- END LOGO --> 
