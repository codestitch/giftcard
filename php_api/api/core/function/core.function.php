<?php
	...
	switch ($function) {
		...
		case 'fb_login':
			...
			echo $class->fb_login($email, $pid, $platform, $deviceID, $fname, $mname, $lname, $dob, $gender);
			die();
			break;
		...
		case 'update_member_profile':
			...
			echo $class->update_member_profile($memberID, $fname, $lname, $gender, $address1, $mobileNum, $dob);
			die();
			break;
